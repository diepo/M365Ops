function Remove-M365OpsOutboundConnector {
    <#
    .SYNOPSIS
        Elimina un connettore Outbound. Era Remove-M365OpsSendConnector (cmdlet
    ...
    Write-Host "Connettore Outbound rimosso: $Identity" -ForegroundColor Green
